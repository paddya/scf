...
/**
 * The porter is picky about clients to let in. It forwards every subsequent
 * command to the corresponding player thread
 *
 * @author markus
 */
public class Porter extends Thread
{
    ...
    public void run()
    {
        System.out.println("Porter running: " + socket.getRemoteSocketAddress());
        try {
    ...
    {
        socket.close();
        System.out.println("Porter closed:  " + socket.getRemoteSocketAddress());
    }
}
